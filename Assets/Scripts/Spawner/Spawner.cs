...
public class Spawner : MonoBehaviour
{
    ...
    [Header("Bonus")]
    [SerializeField] private Bonus _bonusTemblate;
    ...
    private void Start()
    {
        ...
        for (int i = 0; i < _repeatCount; i++)
        {
            ...
            GenerateRandomElements(_wallSpawnPoints, _wallTemplate.gameObject, _wallSpawnChance, _distanceBetweenBonusLine, _distanceBetweenBonusLine / 2f);
            GenerateRandomElements(_blockSpawnPoints, _bonusTemblate.gameObject, _bonusSpawnChance);
        }
    }
